 ...
 *
 * -op sign -keystore /Users/kevinjones/.keystore -keypass p4ssw0rd -keyStorePass p4ssw0rd  -f build.gradle -s -d build.gradle.sign -encode -o -a SHA256withRSA -alias mydomain
 *
 * Note that the algorithm (SHA1withRSA) matches the keyalg (RSA)
 */
